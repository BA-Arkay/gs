    ...
    <div class="col-12">
        <div class="card mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <i class="fa fa-asterisk"></i> Received Rolls
                </h6>
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                    ...
                    <a id="export_excel" class="dropdown-item text-success" href="javascript:void(0);"><i class="fa fa-lg fa-file-excel"></i> Export as Excel</a>

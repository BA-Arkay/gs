...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  ...
  <button class="btn btn-success btn-md" id="refresh">
    ...
    <a href="<?php //url("views/rack_report"); ?>" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm">
      <i class="fas fa-table text-white-50"></i> All Moved Rolls List
    </a>
  </div>
</div>
        ...
        <form id="inputForm" action="" method="post" class="row">
          <div class="col-5">
            <div class="input-group input-group-lg">
              <input type="text" class="form-control" id="location" name="location" placeholder="Scan Targeted Box Barcode ..." autofocus="on" autocomplete="off">
            </div>
          </div>

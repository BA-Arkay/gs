...
<section class="row">
  ...
  <div class="card shadow mb-4">
      ...
      <a href="#collapseCardExample" class="d-block card-header py-3 <?=isset($_GET['store_id'])?null:'collapsed';?>" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="collapseCardExample">
        <h6 class="m-0 font-weight-bold text-success">
          <i class="fa fa-plus"></i> Add New RACK
        </h6>
      </a>
      <!-- Card Content - Collapse -->
      <div class="collapse <?=isset($_GET['store_id'])?'show':null;?>" id="collapseCardExample" style="">
        <div class="card-body">


          <form id="rack_form"  method="post" class="row">
            ...
            <div class="col-6">
              <div class="form-group">
                <label for="">Rack Title</label>
                <div class="input-group input-group-lg">
                  <input id="racks_title" type="text" class="form-control" placeholder="Rack title">
                </div>
              </div>
            </div>
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        <table class="table table-bordered table-striped">
          ...
          <tbody id="racks">
            <!-- there wiil be append raks datam -->
          </tbody>
        </table>

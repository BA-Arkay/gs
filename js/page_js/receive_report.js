$(document).ready(function () {
        ...
        $.ajax({
		    ...
		    //console.log(data.item_detail);
                    ...
                    for (let single in yarn_details) {
                        // yarn_count = `${yarn_count } ${yarn_details[single].yc ? yarn_details[single].yc : ''}`;
                        ...
                        yarn_type = yarn_details[single].yt;
                        yarn_count += yarn_details[single].yc + yarn_type;
                    }

                   //console.log(yarn_details);
                    
                    fabric_style = yarn_count + " " + data.item_detail.fabric_type;
                    ...
                    gridArrayData.push({
                        ...
                        Weight: data.item_detail.weight ? data.item_detail.weight : 0.0,
                        ...
                        finished_width: data.item_detail.finished_width ? data.item_detail.finished_width : 'N/A',
                        ...
                        yarn_barnd: yarn_brand ? yarn_brand : 'N/A',
			...
			mode_of_transaction : 'Received-G',
			transaction_code : 202,
			uom : 'KG',

                        Received_by: data.received_by ? data.received_by : 'UNKNOWN',
                        Received_at: data.received_at ? data.received_at : 'N/A'
    ...
    $("#export_excel").on("click", function () {
        $("#jqGrid").jqGrid("exportToExcel", {
            ...
            includeFooter: true,
            fileName: `${date}-${month}-${year}_${hours}-receiving_report.xlsx`,
